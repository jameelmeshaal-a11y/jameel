      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-hidden flex flex-col" dir="rtl">
        ...
        <div className="grid grid-cols-4 gap-3 py-3">
          <div className="rounded-lg border bg-muted/30 p-3 text-center">
            <div className="text-2xl font-bold">{activeReport.totalChecked}</div>
          ...
          <div className="rounded-lg border bg-emerald-50 dark:bg-emerald-950/30 p-3 text-center">
            <div className="text-2xl font-bold text-emerald-600">{activeReport.healthyCount}</div>
          ...
          <div className="rounded-lg border bg-amber-50 dark:bg-amber-950/30 p-3 text-center">
            <div className="text-2xl font-bold text-amber-600">{activeReport.summary.warning}</div>
          ...
          <div className="rounded-lg border bg-red-50 dark:bg-red-950/30 p-3 text-center">
            <div className="text-2xl font-bold text-red-600">{activeReport.summary.critical}</div>
