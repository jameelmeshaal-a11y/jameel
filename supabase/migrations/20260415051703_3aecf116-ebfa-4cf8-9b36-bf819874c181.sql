-- 1. Replace save_manual_price to propagate manual protection to linked items
...
BEGIN
  ...
  -- *** FIXED: Propagate manual protection to linked sub-items ***
...
-- 2. Guard trigger: protect manual overrides from automated changes
...
FOR EACH ROW EXECUTE FUNCTION public.guard_manual_override();
